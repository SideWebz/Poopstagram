    ...
    <div style={{ 
      ...
      <div className="auth-container" style={{ animation: 'fadeIn 0.4s ease-out' }}>
        ...
        <form onSubmit={handleSubmit} className="auth-form">
          ...
          >
            {loading ? (
              ...
              <>
                <i className="bi bi-person-plus-fill" style={{ marginRight: '0.5rem' }}></i>
                Sign up
              </>
            )}
          </button>
        ...
        <div className="auth-footer" style={{ 
          ...
          Have an account? <Link to="/login" style={{ color: 'var(--accent)', fontWeight: '600', textDecoration: 'none' }}>Log in</Link>
        </div>
      </div>
      <style>{`
        @keyframes fadeIn {
